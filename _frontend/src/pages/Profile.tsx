      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <p className="font-medium italic">Made in TypeScript JSX</p>
            ...
            <div className="mt-4.5 mx-auto max-w-180">
              ...
              <p className="mt-4.5">
                We at Red Lobsters LLC have a succinct focus on making features
                from the user's perspective. From easy to understand UI to 
                quality of life implementation; client satisfaction is our
                passion. We are a team of programmers willing to be contracted
                for any fullstack web development project.
              </p>
            </div>

            <div className="mt-6.5">
              <h4 className="mb-3.5 font-medium text-black dark:text-white">
                Like the website? Follow us on:
              </h4>
